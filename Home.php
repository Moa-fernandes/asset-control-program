...
<body>
	<div class="container">
		...
		if($linha != 0){
				...
				echo "
                    ...
                    <img style='max-width:300px; width:70px'src='src/mouagro.png' alt=''>
					</a>
	...
	<footer class="footer" style="position: fixed; bottom: 0px;background-color: black;width: 100%;">
				<div class="container">
					...
					<p>Feito por <a href="https://github.com/Moa-fernandes" target='_blank'><font color='grey'>Moa Fernandes/2024</font></a></p>
				</div>
			</footer>
</body>
